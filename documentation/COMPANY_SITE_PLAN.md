# Flux Dynamics - Company Website Plan

## Context

Flux Dynamics is a single-page company website deployed via GitHub Pages. Built with Jekyll, Tailwind CSS v4, and vanilla JavaScript, it showcases projects as the primary focus, company stats, founder profiles (secondary), and contact details.
...
2. Confirm all references say "Flux Dynamics" (no "AGN Technology" remnants)
...
11. Verify contact links point to fluxdynamics placeholders
